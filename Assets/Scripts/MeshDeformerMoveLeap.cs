...
namespace Leap.Unity
{
    ...
    public class MeshDeformerMoveLeap : MonoBehaviour
    {
        private Mesh mesh;
        ...
        /**
        * Converts the mouse position (2D) to world coordinate (3D) : à priori ne sert plus à rien
        */
        ...
        */
        private void selectVertices(in Ray ray)
        {
            ...
            if (meshCollider.Raycast(ray, out hit, 100))
            {
                ...
                lastMousePos = LeapEventManager.GetPointingDirection();
        ...
        */
        ...
        {
            Ray ray = Camera.main.ScreenPointToRay(LeapEventManager.GetPointingDirection());
            selectVertices(ray);
        }
